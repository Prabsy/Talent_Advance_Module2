...
export default class TalentCard extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
            {feedData.map((talent) => {
                console.log("SKILLS:"+talent.skills)
          key:""
          return (
                  ...
                  <div className="extra content grid">
                    ...
                    <i class="github icon"></i>
                          ...
                          <div className="extra content">
                              {
                                  talent.skills ? (talent.skills.map(item => {
                                      return <div className="bottom_text">{item.value}</div>
                                  })) :
                                      (
                  ...
                  <div className="extra content grid">
                    ...
                    <i class="github icon"></i>
                              ...
                              <div className="extra content">
                                  {
                                      talent.skills ? (talent.skills.map(item => {
                                          return <div className="bottom_text">{item}</div>
                                      })) :
                                          (<div className="bottom_text">C#</div>)
